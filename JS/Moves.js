...
var Move = Class.extend({
	...
	collision :function (){
		...
		var colShurikenF2 = false;
		  ...
		  var bX = bonusFigure.xPos;
		  var bY = bonusFigure.yPos;
		  ...
		  if (this.F1.orientation == "left"){
			...
			if ((bX+40 >=  pX1 &&	bX <= pX1+106) && bonusFigure.stop == true){				
				colCurrentBonusF1 = true;				
			} else if ((bX+40 >=pX2 && bX<=pX2+106) && bonusFigure.stop == true){
				colCurrentBonusF2 = true;
			}
	  ...
	  draw :function() {		  
		var that = this;			  
			  if(this.collision()[1]){				  
				  bonusFigure.ctx.clearRect(0, 0 , 900, 600);			  
				  bonusFigure.stop =false;
				  bonusFigure.xPos = Math.floor((Math.random() * (bonusFigure.c.width - 50)) + 1);
				  bonusFigure.yPos = 5;
				  if (bonusFigure.currIndex == 0){
					  console.log("heart");
					  this.F1.hpBar.draw(30,true);
				  }else if (bonusFigure.currIndex == 1){
					  console.log("shamrock");
					  this.F1.nrgBar.draw(30,true);
				  }
				  bonusFigure.randomIndex = Math.floor(Math.random() * 2);  
				  ...
				  if (bonusFigure.currIndex == 0){
					  console.log("heart");
					  this.F2.hpBar.draw(30,true);
				  }else if(bonusFigure.currIndex == 1){
					  console.log("shamrock");
					  this.F2.nrgBar.draw(30,true);
				  }
				  bonusFigure.randomIndex = Math.floor(Math.random() * 2);
			  }
...
//		console.log(this.collision()[4]);
//		console.log(this.collision()[5]);
		var that = this;
...
//var x = new Moves('assets/images/Kick.png',Kick);
